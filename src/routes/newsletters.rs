...
//         .get("Authorization")
//         .context("The 'Authorizatio' header was missing")?
//         .to_str()
//         .context("The 'Authorizatio' header was not a valid UTF8 string.")?;
...
//     // Could also use query_as and directly decode into a model
